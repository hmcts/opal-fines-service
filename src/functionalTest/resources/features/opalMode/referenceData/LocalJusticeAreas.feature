...
Feature: Local Justice Areas Reference Data
 ...
 #PO-312
  ...
  @JIRA-STORY:PO-2757 @JIRA-EPIC:PO-2750 @JIRA-KEY:POT-4546
  Scenario: Happy path without lja_type returns all LJAs
    Given I am testing as the "opal-test@dev.platform.hmcts.net" user
    When I make a request to the LJA ref data api with
    Then the response status code is 200

  @JIRA-STORY:PO-2757 @JIRA-EPIC:PO-2750 @JIRA-KEY:POT-4547
  ...
  @JIRA-STORY:PO-2757 @JIRA-EPIC:PO-2750 @JIRA-KEY:POT-4548
