...
Feature: Major Creditor Account History
  ...
  @JIRA-STORY:PO-2654 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-9542
  Scenario: Major creditor account history - E2E.01 Happy path history retrieval
  ...
  @JIRA-STORY:PO-2654 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-9543
  Scenario: Major creditor account history - E2E.02 Filter contract and idempotence
    Given I am testing as the "opal-test@dev.platform.hmcts.net" user
  ...
  @JIRA-STORY:PO-2654 @JIRA-EPIC:PO-2655 @JIRA-NFR:PO-2507 @JIRA-TEST-KEY:PO-9544
  Scenario: Major creditor account history - E2E.03 Authentication and authorization
  ...
  @JIRA-STORY:PO-2654 @JIRA-EPIC:PO-2655 @JIRA-TEST-KEY:PO-9545
  Scenario: Major creditor account history - E2E.04 Not found behaviour
    Given I am testing as the "opal-test@dev.platform.hmcts.net" user
