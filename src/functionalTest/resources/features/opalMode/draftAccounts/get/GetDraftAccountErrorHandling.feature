...
Feature: Get Draft Account Error Handling
  ...
  @JIRA-STORY:PO-690 @JIRA-EPIC:PO-2219 @cleanUpData @JIRA-TEST-KEY:PO-5645
  ...
  @JIRA-STORY:PO-690 @JIRA-EPIC:PO-2219 @cleanUpData @JIRA-TEST-KEY:PO-5646
  ...
  @JIRA-STORY:PO-690 @JIRA-EPIC:PO-2219 @cleanUpData @JIRA-TEST-KEY:PO-5647
  ...
  @JIRA-STORY:PO-690 @JIRA-EPIC:PO-2219 @cleanUpData @JIRA-TEST-KEY:PO-5648
  Scenario: Retrieving a draft account with an invalid identifier is rejected
    When I get the draft account "not A Long"
    Then the request is rejected as not acceptable

  @JIRA-STORY:PO-690 @JIRA-EPIC:PO-2219 @cleanUpData @JIRA-TEST-KEY:PO-5649
