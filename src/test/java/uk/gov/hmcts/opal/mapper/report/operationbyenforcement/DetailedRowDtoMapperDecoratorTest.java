...
import uk.gov.hmcts.opal.service.report.operationbyenforcement.mapper.DetailedRowDtoMapperDecorator;
...
class DetailedRowDtoMapperDecoratorTest {
    ...
    void map_shouldApplyAllDecorationsForMacNewAccount() {
        ...
        OperationByEnforcementDetailedReportAccountRowDto dto =
            new OperationByEnforcementDetailedReportAccountRowDto();
        ...
        OperationByEnforcementDetailedReportAccountRowDto result = decorator.map(entity, context);
    ...
    private static <T> BiConsumer<T, OperationByEnforcementDetailedReportAccountRowDto> anyBiConsumer() {
