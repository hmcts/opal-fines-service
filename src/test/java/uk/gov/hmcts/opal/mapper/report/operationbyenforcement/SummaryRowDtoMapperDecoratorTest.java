...
import uk.gov.hmcts.opal.dto.report.operationbyenforcement.OperationByEnforcementReportBaseRowDto;
...
import uk.gov.hmcts.opal.service.report.operationbyenforcement.mapper.SummaryRowDtoMapperDecorator;
...
class SummaryRowDtoMapperDecoratorTest {
    ...
    void shouldCallDelegateMap() {
        ...
        OperationByEnforcementReportBaseRowDto result = decorator.map(entity, context);
