...
class DetailedRowDtoCoreMapperTest {

    public static final String ACCOUNT_NO = "ACC123";
    public static final String COURT_NAME = "Test Court";
    public static final String ORGANISATION_NAME = "Organisation1";
    ...
    void shouldMapBasicFields() {
        ...
        entity.setAccountNumber(ACCOUNT_NO);
        ...
        SummaryOperationReportRowDto dto = mapper.map(entity, context);

        assertThat(dto.getHeader1()).isEqualTo("DETAIL");
        assertThat(dto.getAccountNo()).isEqualTo(ACCOUNT_NO);
