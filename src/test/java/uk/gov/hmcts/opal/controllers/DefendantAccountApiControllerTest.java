...
class DefendantAccountApiControllerTest {
    ...
    void testGetDefendantAccountEnforcementStatus_Success() {
        ...
        // Act
        ResponseEntity<GetDefendantAccountEnforcementStatusResponse> response =
            defendantAccountApiController.getDefendantAccountEnforcementStatus(1L, BEARER_TOKEN);

        // Assert
        assertEquals(HttpStatus.OK, response.getStatusCode());

        GetDefendantAccountEnforcementStatusResponse body = response.getBody();
