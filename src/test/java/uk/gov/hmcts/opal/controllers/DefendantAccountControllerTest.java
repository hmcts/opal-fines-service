...
class DefendantAccountControllerTest {
    ...
    public void testGetDefendantAccount_Success() {
        // Arrange
        DefendantAccount.Lite mockResponse = new DefendantAccount.Lite();

        when(defendantAccountService.getDefendantAccount(any(AccountEnquiryDto.class))).thenReturn(mockResponse);

        // Act
        ResponseEntity<DefendantAccount.Lite> responseEntity = defendantAccountController.getDefendantAccount(
    ...
    public void testPutDefendantAccount_Success() {
        // Arrange
        DefendantAccount.Lite requestEntity = new DefendantAccount.Lite();
        DefendantAccount.Lite mockResponse = new DefendantAccount.Lite();

        when(defendantAccountService.putDefendantAccount(any(DefendantAccount.Lite.class))).thenReturn(mockResponse);

        // Act
        ResponseEntity<DefendantAccount.Lite> responseEntity = defendantAccountController.putDefendantAccount(
