...
public class DefendantAccountPaymentTermsServiceProxy implements DefendantAccountPaymentTermsServiceInterface,
    ...
    @Override
    public GetDefendantAccountPaymentTermsResponse addPaymentTerms(Long defendantAccountId, String businessUnitId,
        String businessUnitUserId, String ifMatch, AddDefendantAccountPaymentTermsRequest addPaymentTermsRequest) {
        return getCurrentModeService().addPaymentTerms(defendantAccountId, businessUnitId,
            businessUnitUserId, ifMatch, addPaymentTermsRequest);
    }
}
