...
public class LegacyDefendantAccountService extends LegacyService implements DefendantAccountServiceInterface {
    ...
    public DefendantAccount.Lite getDefendantAccount(AccountEnquiryDto request) {
        ...
        return postToGateway(GET_DEFENDANT_ACCOUNT, DefendantAccount.Lite.class, request);
    }
    ...
    public DefendantAccount.Lite putDefendantAccount(DefendantAccount.Lite defendantAccountEntity) {
        ...
        return postToGateway(PUT_DEFENDANT_ACCOUNT, DefendantAccount.Lite.class, defendantAccountEntity);
    }
