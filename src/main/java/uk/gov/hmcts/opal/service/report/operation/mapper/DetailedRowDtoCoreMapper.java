...
public interface DetailedRowDtoCoreMapper extends CommonMappingHelper {
    ...
    DetailedOperationReportAccountRowDto map(DefendantAccountEntity entity, ReportMetadataContext context);
    ...
    void mapParty(PartyEntity party, @MappingTarget DetailedOperationReportAccountRowDto dto);
    ...
    void mapDebtor(DebtorDetailEntity debtor,
        @MappingTarget DetailedOperationReportAccountRowDto dto);
