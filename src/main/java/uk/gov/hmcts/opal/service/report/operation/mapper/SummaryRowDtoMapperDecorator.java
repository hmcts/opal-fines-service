...
public class SummaryRowDtoMapperDecorator
    ...
    @Override
    public SummaryOperationReportRowDto map(DefendantAccountEntity entity, ReportMetadataContext context) {
        ...
        SummaryOperationReportRowDto dto = delegate.map(entity, context);
    ...
    private void applyLatestEnforcement(DefendantAccountEntity entity, SummaryOperationReportRowDto dto) {
    ...
    @Override
    public void mapParty(PartyEntity party, SummaryOperationReportRowDto dto) {
        delegate.mapParty(party, dto);
    }

    @Override
    public void mapDebtor(DebtorDetailEntity debtor, SummaryOperationReportRowDto dto) {
