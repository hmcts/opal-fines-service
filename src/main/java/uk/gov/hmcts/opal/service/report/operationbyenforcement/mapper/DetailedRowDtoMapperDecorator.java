...
public class DetailedRowDtoMapperDecorator
    ...
    @Override
    public OperationByEnforcementDetailedReportAccountRowDto map(DefendantAccountEntity entity,
        ...
        OperationByEnforcementDetailedReportAccountRowDto dto = delegate.map(entity, context);
    ...
    private void applyAccountHeaderView(DefendantAccountEntity entity,
        OperationByEnforcementDetailedReportAccountRowDto dto) {
    ...
    private void applyArrears(DefendantAccountEntity entity, OperationByEnforcementDetailedReportAccountRowDto dto) {
        Long accountId = entity.getDefendantAccountId();
    ...
    @Override
    public void mapParty(PartyEntity party, OperationByEnforcementDetailedReportAccountRowDto dto) {
        delegate.mapParty(party, dto);
    }

    @Override
    public void mapDebtor(DebtorDetailEntity debtor, OperationByEnforcementDetailedReportAccountRowDto dto) {
        delegate.mapDebtor(debtor, dto);
    }

    @Override
    public void mapImpositions(ImpositionTotalsDto impositions, OperationByEnforcementDetailedReportAccountRowDto dto) {
        delegate.mapImpositions(impositions, dto);
    }
}