...
@Data
public class OperationDetailedReport implements ReportDataInterface {
    ...
    public long getNumberOfRecords() {
        List<DetailedAccountReportDto> transactionList =
            detailedReport.getAccountTransactionReports();
