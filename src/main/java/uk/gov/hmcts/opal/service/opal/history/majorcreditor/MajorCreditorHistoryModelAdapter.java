...
import uk.gov.hmcts.opal.entity.CreditorTransactionStatus;
import uk.gov.hmcts.opal.entity.CreditorTransactionType;
...
public final class MajorCreditorHistoryModelAdapter {
    ...
    public static AccountHistoryItem toCoreItem(CreditorTransactionEntity entity) {
        return AccountHistoryItem.builder()
            ...
            .details(AccountHistoryCreditorTransactionDetails.builder()
                .transactionType(toValue(entity.getTransactionType()))
                .paymentReference(entity.getPaymentReference())
                .status(toValue(entity.getStatus()))
                .statusDate(entity.getStatusDate())
                .associatedRecordType(toValue(entity.getAssociatedRecordType()))
                .associatedRecordId(entity.getAssociatedRecordId())
                .build())
            .amount(entity.getTransactionAmount())
            .eventDateTime(entity.getPostedDate())
            .sourceId(entity.getCreditorTransactionId())
            .build();
    }

    private static String toValue(CreditorTransactionType transactionType) {
        return transactionType == null ? null : transactionType.getValue();
    }

    private static String toValue(CreditorTransactionStatus status) {
        return status == null ? null : status.getValue();
    }

    private static String toValue(AssociatedRecordType associatedRecordType) {
