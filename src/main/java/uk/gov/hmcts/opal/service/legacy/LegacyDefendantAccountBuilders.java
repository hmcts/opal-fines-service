...
public class LegacyDefendantAccountBuilders {
    ...
    static GetDefendantAccountEnforcementStatusResponse toEnforcementStatusResponse(
        ...
        return EnforcementStatus.builder()
            .employerFlag(Boolean.getBoolean(legacy.getEmployerFlag())) // Legacy response is true/false
    ...
    static DefendantAccountTypeEnum buildDefendantAccountTypeEnum(String string) {
        return DefendantAccountTypeEnum.valueOf(string);
    }
