...
public class SrvcGetPppLocked extends TechSpikeAction {
    ...
    public SrvcGetPppLocked(DraftAccountService draftAccountService, DraftAccountController controller,
    ...
    public CallResponse doIt() {
        ...
        DraftAccountEntity entity = getDraftAccountEntityPLocked(id, slept);
        long delta = timeMe(start);

        return successCallResponse("Srvc Get P Lock '", entity, delta, slept);
    }
}
