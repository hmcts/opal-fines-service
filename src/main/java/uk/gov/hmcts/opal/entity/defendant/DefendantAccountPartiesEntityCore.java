...
// @XmlType(name = "DefendantAccountPartiesEntityCore")
public class DefendantAccountPartiesEntityCore extends DefendantAccountPartiesEntity {

    @ManyToOne(cascade = CascadeType.ALL, fetch = FetchType.LAZY)
    @JoinColumn(name = "defendant_account_id", nullable = false)
    private DefendantAccountCore defendantAccount;
