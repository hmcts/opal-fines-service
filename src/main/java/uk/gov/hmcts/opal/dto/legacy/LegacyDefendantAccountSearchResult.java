...
public class LegacyDefendantAccountSearchResult implements ToJsonString, FullNameBuilder {
    ...
    public DefendantAccountSummaryDto toDefendantAccountSummaryDto() {
        return DefendantAccountSummaryDto.builder()
            ...
            .birthDate(!organisation && birthDate != null ? birthDate.toString() : null)
            .addressLine1(addressLine1)
            .accountBalance(accountBalance)
            .organisation(organisation)
            .aliases(aliases != null
            ? aliases.stream().map(LegacyAliasDto::toAliasDto).toList()
            : List.of())
            .postcode(postcode)
            ...
            .nationalInsuranceNumber(organisation ? null : nationalInsuranceNumber)
            .parentGuardianSurname(organisation ? null : parentGuardianSurname)
            .parentGuardianFirstnames(organisation ? null : parentGuardianFirstnames)
            .build();
    }
