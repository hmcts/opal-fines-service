...
public class DraftAccountController {
    ...
    private final DraftAccountServiceInterface draftAccountService;

    private final DraftAccountService opalDraftAccountService; // Might not be needed

    private final UserStateService userStateService;

    public DraftAccountController(@Qualifier("draftAccountService") DraftAccountServiceInterface draftAccountService,
                           UserStateService userStateService, DraftAccountService opalDraftAccountService) {
