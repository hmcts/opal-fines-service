...
INSERT INTO public.reports (report_id, report_title, report_group, audited_report, report_parameters, supports_multi_bu, is_bespoke_journey, shown_as_worklist, retention_period, permission, supported_file_types, can_manually_create) VALUES
	...
	('operational_report_enforcement', 'Operational report (by enforcement)', 'Operational Reports', false, NULL, false, false, false, '14', NULL, '{CSV,PDF}', true),
	('operational_report_payment', 'Operational report (by payment)', 'Operational Reports', false, NULL, false, false, false, '14', NULL, '{CSV,PDF}', true);
