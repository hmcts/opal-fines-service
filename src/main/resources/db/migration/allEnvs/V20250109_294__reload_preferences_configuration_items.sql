...
* ----------    -------     --------    ----------------------------------------------------------------------------------------------------------------------------------
* 09/01/2025    A Dennis    1.0         PO-1064 Rerunning these preferences configuation items for them to use the new values from the sequence configuration_item_id_seq.
**/
