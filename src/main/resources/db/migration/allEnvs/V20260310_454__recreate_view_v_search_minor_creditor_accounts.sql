...
* 06/03/2026    TMc         1.3         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20250916_414__amend_view_v_search_minor_creditor_accounts.sql
*                                                   Only change: Added DROP statement
**/
DROP VIEW IF EXISTS v_search_minor_creditor_accounts;
