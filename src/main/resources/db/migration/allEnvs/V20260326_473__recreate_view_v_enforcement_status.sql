...
*                                       Taken from: V20250910_409__create_view_v_enforcement_status.sql
*                                                   Only change: Added DROP statement
* 17/03/2026    T McCallion 1.2         Need to recreate view as part of new ENUMs work (PO-2868)
*                                       Taken from: V20260310_453__recreate_view_v_enforcement_status.sql. No changes
*
**/
DROP VIEW IF EXISTS v_enforcement_status;
