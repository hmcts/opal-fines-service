...
* ----------    -------     --------    ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------
* 09/01/2025    Capita      1.0         PO-1064 This script was written by Capita. It creates configuration items required for interface files. Rerunning it because the start value for the sequence configuration_item_id_seq has changed.
*
**/
/* Interfaces */
