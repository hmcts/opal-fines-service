...
BEGIN
    ...
    -- Determine originator_type and report_id - It is FP and fp_register if fp_ticket_detail exists, TFO and tfo_in_register if no fp_ticket_detail exists
    -- v4.0 - Added IF statement
    IF v_fp_ticket_detail_json IS NOT NULL THEN
        v_originator_type := 'FP';
        v_report_id       := 'fp_register';
    ELSE
        v_originator_type := 'TFO';
