...
*                                       Taken from: V20260224_447__create_view_v_consolidated_accounts.sql
*                                                   Only change: Added DROP statement
* 16/03/2026    T McCallion 1.2         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20260310_462__recreate_view_v_consolidated_accounts.sql. No changes
*
**/

DROP VIEW IF EXISTS v_consolidated_accounts;
