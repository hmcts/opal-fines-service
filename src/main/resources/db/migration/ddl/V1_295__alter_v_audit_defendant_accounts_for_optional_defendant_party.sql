...
*                                          Taken from: V20250827_388__create_view_v_audit_defendant_accounts.sql
*                                                   Only change: Added DROP statement
* 17/03/2026    T McCallion    1.2         Need to recreate view as part of new ENUMs work
*                                          Taken from: V20260310_451__recreate_view_v_audit_defendant_accounts.sql
* 17/08/2026    P Brumby       1.3         PO-9756 Make Defendant party association optional for audit finalise
*                                          Taken from: V20260327_476__recreate_view_v_audit_defendant_accounts.sql
*
**/
...
AS
 ...
 LEFT JOIN defendant_account_parties dap_def
        ON da.defendant_account_id = dap_def.defendant_account_id
       AND dap_def.association_type = 'Defendant'::t_association_type_enum
 LEFT JOIN parties p_def
 ...
 LEFT JOIN defendant_account_parties dap_pg
       ...
       AND dap_pg.association_type = 'Parent/Guardian'::t_association_type_enum
