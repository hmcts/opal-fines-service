...
* 06/03/2026    T McCallion 1.2         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20251204_434__amend_view_v_defendant_accounts_header.sql
*                                                   Only change: Added DROP statement
* 10/03/2026    T McCallion 1.3         Need to recreate view as part of new ENUMs work (PO-2931)
*                                       Taken from: V20260310_460__recreate_view_v_defendant_accounts_header.sql. No changes
* 17/03/2026    T McCallion 1.4         Need to recreate view as part of new ENUMs work (PO-2868)
*                                       Taken from: V20260316_465__recreate_view_v_defendant_accounts_header.sql. No changes
* 17/07/2026    C Cho       1.5         PO-2976 - Add originator_type and originator_name to defendant account header view.
*
**/
DROP VIEW IF EXISTS v_defendant_accounts_header;
