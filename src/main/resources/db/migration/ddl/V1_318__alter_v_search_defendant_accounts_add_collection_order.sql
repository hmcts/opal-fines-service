...
* CGI OPAL Program
*
* MODULE      : alter_v_search_defendant_accounts_add_collection_order.sql
*
* DESCRIPTION : Add collection_order to Search Defendant Accounts view
*
* VERSION HISTORY:
*
...
*                                       Taken from: V20250929_417__create_view_v_search_defendant_accounts.sql
*                                                   Only changes: Removed DROP statement for v_search_def_account_and_alias, added DROP for this view
* 17/03/2026    T McCallion 1.3         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20260310_456__recreate_view_v_search_defendant_accounts.sql. No changes
* 03/09/2026    C Cho       2.0         PO-3478 - Add collection_order to Search Defendant Accounts view
*
**/
