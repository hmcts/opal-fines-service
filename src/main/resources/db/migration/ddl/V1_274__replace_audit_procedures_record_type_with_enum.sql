DROP PROCEDURE p_audit_initialise;

CREATE PROCEDURE p_audit_initialise(
    IN pi_associated_account_id bigint,
    IN pi_record_type t_associated_record_type_enum
)
    LANGUAGE plpgsql
    AS $$
/**
...
* 24/07/2026    C Cho       2.0         PO-2977 Replace pi_record_type varchar parameter with enum.
*
**/
DECLARE
...
DROP PROCEDURE p_audit_finalise;

CREATE PROCEDURE p_audit_finalise(
    IN pi_associated_account_id bigint,
...
* 15/06/2026    T McCallion 3.0         PO-3619 AMENDMENTS.ASSOCIATED_RECORD_TYPE has been altered to use enum. Insert updated to cast to enum.
* 24/07/2026    C Cho       4.0         PO-2977 Replace pi_record_type varchar parameter with enum.
*
**/
DECLARE
    v_pg_exception_detail            TEXT;
                ...
                IF COALESCE(v_new_value, '') != COALESCE(v_old_value, '') THEN
                    ...
                    IF v_field_code IS NOT NULL THEN
                        ...
                        VALUES (
                            ...
                            pi_record_type::t_associated_record_type_enum,
