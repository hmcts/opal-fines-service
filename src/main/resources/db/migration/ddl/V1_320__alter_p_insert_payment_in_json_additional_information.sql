DROP PROCEDURE IF EXISTS p_insert_payment_in;

CREATE PROCEDURE p_insert_payment_in(
...
* OPAL Program
*
* MODULE      : alter_p_insert_payment_in_json_additional_information.sql
*
...
*                                       SP dropped and recreated to update parameter data types. No other changes. 
* 09/09/2026    C Cho       2.1         PO-3410 - Recompile the procedure to use new column data type for additional_information.
*
**/
BEGIN
