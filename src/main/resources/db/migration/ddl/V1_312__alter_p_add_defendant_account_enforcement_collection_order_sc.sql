DROP PROCEDURE p_add_defendant_account_enforcement;

CREATE PROCEDURE public.p_add_defendant_account_enforcement(
...
* CGI OPAL Program
*
* MODULE      : alter_p_add_defendant_account_enforcement_collection_order_sc.sql
*
