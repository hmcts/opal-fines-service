...
* CGI OPAL Program
*
* MODULE      : recreate_view_v_search_defendant_accounts_consolidation.sql
*
...
* 17/03/2026    T McCallion 3.0         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20260310_463__amend_view_v_search_defendant_accounts_consolidation.sql. No changes.
* 17/07/2026    P Brumby    4.0         PO-5740 - Include TO and TS account statuses in consolidation search errors
*
**/
...
SELECT 
    ...
    CASE 
        WHEN (
            ...
            (CASE WHEN vsda.account_status IN ('TA', 'WO', 'CS', 'TO', 'TS') THEN 1 ELSE 0 END) +
        ...
        ELSE 
            ARRAY_REMOVE(
                ARRAY[
                    CASE WHEN vsda.account_status IN ('TA', 'WO', 'CS', 'TO', 'TS') 
