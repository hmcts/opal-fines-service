...
* OPAL Program
*
* MODULE      : alter_v_major_creditor_account_header_for_business_unit_code.sql
*
* DESCRIPTION : Amend v_major_creditor_account_header view to fetch business_units.business_unit_code.
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    -------     --------    -----------------------------------------------------------------------------------------------------------------
* 13/07/2026    P Brumby    1.0         PO-7422 Amend view v_major_creditor_account_header to fetch business_units.business_unit_code for frontend consumption.
*
**/
