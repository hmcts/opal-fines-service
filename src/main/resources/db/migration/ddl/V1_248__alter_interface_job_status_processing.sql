...
* OPAL Program
*
* MODULE      : alter_interface_job_status_processing.sql
*
* DESCRIPTION : Rename the interface job status enum value from PROCESSED to PROCESSING
*               and update dependent database procedures.
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    -------     --------    -----------------------------------------------------------------------------------------------------------------
* 30/07/2026    C Cho       1.0         PO-8956 Replace INTERFACE_JOBS status PROCESSED with PROCESSING.
*
**/

ALTER TYPE t_interface_job_status_enum
    RENAME VALUE 'PROCESSED' TO 'PROCESSING';
...
* 03/06/2026    TMc         1.1         PO-3624 - Update interface job status constants to enum values
* 30/07/2026    C Cho       1.2         PO-8956 - Replace PROCESSED interface job status with PROCESSING
*
**/
DECLARE
