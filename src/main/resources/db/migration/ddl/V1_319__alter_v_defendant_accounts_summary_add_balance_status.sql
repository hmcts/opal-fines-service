...
* CGI OPAL Program
*
* MODULE      : alter_v_defendant_accounts_summary_add_balance_status.sql
*
* DESCRIPTION : Add balance and account_status to Defendant Accounts Summary view
*
* VERSION HISTORY:
*
...
* 06/03/2026    T McCallion 1.4         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20251219_436__amend_view_v_defendant_accounts_summary.sql
*                                                   Only change: added IF EXISTS to DROP statement
* 17/03/2026    T McCallion 1.5         Need to recreate view as part of new ENUMs work
*                                       Taken from: V20260310_461__recreate_view_v_defendant_accounts_summary.sql. No changes
* 04/09/2026    C Cho       2.0         PO-3479 - Add balance and account_status to Defendant Accounts Summary view
*
*
**/

-- Drop view first to allow new columns to be added to existing view
DROP VIEW IF EXISTS v_defendant_accounts_summary;
