...
* OPAL Program
*
* MODULE      : alter_v_major_creditor_account_header_add_business_unit_code.sql
*
* DESCRIPTION : Amend v_major_creditor_account_header so header summary consumers can access the business unit code.
*
* VERSION HISTORY:
*
* Date          Author      Version     Nature of Change
* ----------    -------     --------    -----------------------------------------------------------------------------------------------------------------
* 17/06/2026    OpenAI      1.0         PO-7409 Add business_unit_code to the v_major_creditor_account_header view.
*
**/
