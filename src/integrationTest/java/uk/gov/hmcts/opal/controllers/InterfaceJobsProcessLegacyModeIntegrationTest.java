...
@DisplayName("Interface Jobs Process Legacy Mode Integration Tests")
class InterfaceJobsProcessLegacyModeIntegrationTest extends AbstractIntegrationTest {
    ...
    @Test
    @DisplayName("PO-2593 - Legacy mode rejects interface job processing")
    @JiraStory("PO-2593")
    @JiraEpic("PO-2468")
    void processJobs_returnsFeatureDisabledInLegacyMode() throws Exception {
