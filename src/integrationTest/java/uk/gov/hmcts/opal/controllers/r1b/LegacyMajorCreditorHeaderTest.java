...
@Slf4j(topic = "opal.LegacyMajorCreditorHeaderTest")
class LegacyMajorCreditorHeaderTest extends AbstractIntegrationTest {
    ...
    void getHeaderSummary_successReturnsMappedResponseAndEtag() throws Exception {
        ...
        resultActions
            ...
            .andExpect(jsonPath("$.major_creditor.account_reference.creditor_account_type").value("MJ"))
            .andExpect(jsonPath("$.major_creditor.account_reference.creditor_account_display_name")
