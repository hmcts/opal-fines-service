...
import static uk.gov.hmcts.opal.support.UserServiceStub.createUserStateForBusinessUnit;
...
abstract class MinorCreditorControllerIntegrationTest extends AbstractIntegrationWithSecurityTest {
    ...
    void getMinorCreditorAccount_withBacsPermissionInDifferentBusinessUnit_redactsBacsFields(Logger log)
        ...
        stubAuthorisedUser(createUserStateForBusinessUnit(Map.of(
            GET_MINOR_CREDITOR_BUSINESS_UNIT_ID, List.of(FinesPermission.SEARCH_AND_VIEW_ACCOUNTS),
            (short) 20, List.of(FinesPermission.SEARCH_AND_VIEW_ACCOUNTS, FinesPermission.VIEW_CREDITOR_BACS)
        )));
    ...
    void getMinorCreditorAccount_authenticatedWithoutPermission_returns403() throws Exception {
        // Arrange
        stubUserWithNoPermissions(GET_MINOR_CREDITOR_BUSINESS_UNIT_ID);
    ...
    void getMinorCreditorAccount_timeout_returns408(Logger log) throws Exception {
        // Arrange
        stubUserServiceStatus(REQUEST_TIMEOUT.value());
    ...
    void getMinorCreditorAccount_serviceUnavailable_returns503(Logger log) throws Exception {
        // Arrange
        stubUserServiceStatus(SERVICE_UNAVAILABLE.value());
    ...
    void getMinorCreditorAccount_serverError_returns500(Logger log) throws Exception {
        // Arrange
        stubUserServiceStatus(INTERNAL_SERVER_ERROR.value());
    ...
    void getMinorCreditorAccountImpl_filtersBacsDetailsWithoutPermission(Logger log) throws Exception {
        stubUserWithPermissions((short) 77, FinesPermission.SEARCH_AND_VIEW_ACCOUNTS);
