...
INSERT INTO public.enforcements(enforcement_id, defendant_account_id, posted_date, posted_by,
...
WHERE
    public.enforcements.posted_date IS DISTINCT
FROM EXCLUDED.posted_date
    OR public.enforcements.result_id IS DISTINCT
FROM EXCLUDED.result_id;