...
VALUES
    ...
    (
        ...
        25.34,
        NULL,
        'Written off after judgment',
        NULL,
        TIMESTAMP '2026-05-14 11:15:30',
        'JCAM-A',
        'impositions',
        '3',
        NULL
...
DO UPDATE SET
    defendant_account_id   = EXCLUDED.defendant_account_id,
           ...
           write_off_code         = EXCLUDED.write_off_code,
