                 ...
                 "enforcements": [
                   {
                     "result_id": "NOENF",
                     "enforcement_result_responses": [
                       { "parameter_name": "Response2", "response": "No" }
                     ]
                   },
                   {
                     "result_id": "PRIS",
                     "enforcement_result_responses": [
                       { "parameter_name": "Response1", "response": "Yes" }
                     ]
                   },
                   {
                     "result_id": "COLLO",
                     "enforcement_result_responses": [
                       { "parameter_name": "Response3", "response": "Yes" }
                     ]
                   }
                 ]
               },
               "account_notes": [
                 { "account_note_serial": 1, "account_note_text": "First comment", "note_type": "AC" },
                 { "account_note_serial": 3, "account_note_text": "Second AA note", "note_type": "AA" },
