...
BEGIN
    ...
    INSERT INTO creditor_transactions 
        (
            ...
            (8, 4, (CURRENT_TIMESTAMP - INTERVAL '7 days'), 'DRJ8', NULL, 'BACS', 1000, NULL, NULL, NULL, NULL, (CURRENT_TIMESTAMP + INTERVAL '7 days'), NULL, NULL),
            (9, 4, (CURRENT_TIMESTAMP - INTERVAL '5 days'), 'DRJ9', NULL, 'BACS', 2000, NULL, NULL, NULL, NULL, (CURRENT_TIMESTAMP + INTERVAL '5 days'), NULL, NULL),
            (10, 4, (CURRENT_TIMESTAMP - INTERVAL '3 days'), 'DRJ10', NULL, 'BACS', 3000, NULL, NULL, NULL, NULL, (CURRENT_TIMESTAMP + INTERVAL '3 days'), NULL, NULL);
