...
*                                           PO-2846 - local_justice_areas.lja_type
*                                           PO-2869 - parties.account_type
*                                           PO-2868 - defendant_accounts.account_status
*                                           PO-2910 - payment_terms.terms_type_code and instalment_period
*                                           PO-2850 - documents.priority
* 03/09/2026    C Cho       5.0         PO-3479 - Add balance and account_status to v_defendant_accounts_summary tests
*
**/
...
BEGIN
    ...
    (
        v_document_id,
        'DEF',                 -- Must be from allowed list per ENUM
        'EN',                  -- Must be 'EN' or 'CY' per ENUM
        '1',                   -- Must be '0', '1', or '2' per ENUM
        'A',                   -- Must be from allowed list per ENUM if provided
        'Area'                 -- Must be from allowed list per ENUM if provided
    )
...
DECLARE
    ...
    v_debtor_type               t_association_type_enum;
    ...
    v_terms_type_code           t_terms_type_code_enum;
    v_instalment_period         t_instalment_period_enum;
    ...
    FOR i IN 1..2 LOOP
        ...
        CASE i 
            WHEN 1 THEN
                ...
                ASSERT v_balance = 100.00, 'Balance should match';
            ...
            WHEN 2 THEN
                ...
                ASSERT v_version_number = 1, 'Version number should be 1';
                ASSERT v_account_status = 'L', 'Account status should match';
                ASSERT v_balance = 200.00, 'Balance should match';
...
BEGIN
    ...
    --ASSERT v_terms_type_code != 'F', 'Should not return F (Fixed) from inactive record';   --PO-2910 terms_type_code can never be 'F' as per ENUM
