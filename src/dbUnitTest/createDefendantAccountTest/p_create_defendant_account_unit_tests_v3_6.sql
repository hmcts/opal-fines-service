...
BEGIN
    ...
    ASSERT EXISTS (
        SELECT 1 FROM impositions WHERE defendant_account_id = v_defendant_account_id 
                                    ...
                                    AND originator_name = 'LJS' AND original_imposition_id IS NULL --v3.3
...
BEGIN 
    ...
    ASSERT (SELECT originator_name FROM impositions WHERE defendant_account_id = v_defendant_account_id AND result_id = 'FO') = 'LJS'
         , 'IMPOSITIONS - FO - originator_name should match'; --v3.3
    ...
    ASSERT (SELECT originator_name FROM impositions WHERE defendant_account_id = v_defendant_account_id AND result_id = 'FCOMP') = 'LJS'
         , 'IMPOSITIONS - FCOMP - originator_name should match'; --v3.3
