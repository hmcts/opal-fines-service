...
* 06/03/2026    T McCallion    2.0         PO-2856 - Update business_unit_type value to valid ENUM value (Accounting to Accounting Division)
*                                          PO-2869 - Update parties.account_type value to valid ENUM value (Minor Creditor to Creditor)
*
**/
