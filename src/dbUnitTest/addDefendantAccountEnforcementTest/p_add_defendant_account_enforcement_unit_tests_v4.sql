...
BEGIN
    ...
    DELETE FROM enforcements WHERE defendant_account_id IN (90001, 90002, 90003, 90004, 90005, 90006);
    DELETE FROM aliases WHERE party_id IN (90001, 90002, 90003, 90004, 90005, 90006);
    DELETE FROM debtor_detail WHERE party_id IN (90001, 90002, 90003, 90004, 90005, 90006);
    DELETE FROM defendant_account_parties WHERE defendant_account_id IN (90001, 90002, 90003, 90004, 90005, 90006);
    DELETE FROM defendant_accounts WHERE defendant_account_id IN (90001, 90002, 90003, 90004, 90005, 90006);
    DELETE FROM parties WHERE party_id IN (90001, 90002, 90003, 90004, 90005, 90006);
