...
* 26/05/2026    C Cho       2.1         PO-2596 Add amended_by_name audit assertions.
**/
...
BEGIN
    ...
    DELETE FROM report_entries WHERE associated_record_type = 'enforcements' AND associated_record_id IN (SELECT enforcement_id::VARCHAR FROM enforcements WHERE defendant_account_id IN (90001, 90002, 90003, 90004));
    DELETE FROM document_instances WHERE associated_record_type = 'enforcements' AND associated_record_id IN (SELECT enforcement_id::VARCHAR FROM enforcements WHERE defendant_account_id IN (90001, 90002, 90003, 90004));
