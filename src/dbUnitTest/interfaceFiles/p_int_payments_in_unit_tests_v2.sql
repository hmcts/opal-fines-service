...
BEGIN
    ...
    -- config
    DELETE FROM configuration_items WHERE item_name IN ('BANKLIST','INHIBIT_PAYMENT_RESULTS') AND business_unit_id IN (5,14);
    INSERT INTO configuration_items (configuration_item_id,item_name,business_unit_id,item_values)
    VALUES (nextval('configuration_item_id_seq'),'BANKLIST',5,'[{ "sort_code":"123456", "account_number":"01234567", "name":"Bury St Edmunds" },{ "sort_code":"123457", "account_number":"01234568", "name":"Ipswich" }]');
    INSERT INTO configuration_items (configuration_item_id,item_name,business_unit_id,item_values)
    VALUES (nextval('configuration_item_id_seq'),'INHIBIT_PAYMENT_RESULTS',5,'["BWTD","DW","CW"]');
    INSERT INTO configuration_items (configuration_item_id,item_name,business_unit_id,item_values)
    VALUES (nextval('configuration_item_id_seq'),'BANKLIST',14,'[{ "sort_code":"000005", "account_number":"00000005", "name":"BU5A" },{ "sort_code":"000005", "account_number":"10000005", "name":"BU5B" }]');
    INSERT INTO configuration_items (configuration_item_id,item_name,business_unit_id,item_values)
    ...
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
    values (4, 5, '25000004D', 'Fine', -240, 240, 0, 'CS', NULL);
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
    values (5, 5, '25000005E', 'Fine', -200, 200, 0, 'WO', NULL);
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
    values (6, 5, '25000006F', 'Fine', -300, 300, 0, 'TA', NULL);
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
    values (7, 5, '25000007G', 'Fine', -400, 400, 0, 'TS', NULL);
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
    values (8, 5, '25000008H', 'Fine', -500, 500, 0, 'TO', NULL);
    insert into defendant_accounts (defendant_account_id, business_unit_id, account_number, account_type, amount_imposed, amount_paid, account_balance, account_status, last_enforcement)
...
*/
    ...
    INTO v_test_status
    FROM tills
    WHERE till_number = currval('till_number_5_seq')
