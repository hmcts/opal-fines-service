...
*                                           PO-2868 - defendant_accounts.account_status
*                                           PO-2916 - creditor_transactions.transaction_type
* 03/09/2026    C Cho       3.0         PO-3478 - Add collection_order to v_search_defendant_accounts tests
**/
...
DECLARE
    ...
    v_business_unit_type      t_business_unit_type_enum := 'Accounting Division';
   ...
   -- Note - Business units are created from build Flyway
    ...
    INSERT INTO defendant_accounts 
              (
                ...
                (1, 5, '25000001E', 150.00, 100.00, 50.00, 'L', NULL, 'Fine', 'PCR-1', 'DW', TRUE),
                (2, 5, '25000002A', 250.00, 250.00, 0.00, 'CS', '2025-07-01', 'Fixed Penalty', 'PCR-2', NULL, FALSE),
                (3, 8, '25000003T', 300.00, 150.00, 150.00, 'L', NULL, 'Conditional Caution', 'PCR-3', NULL, TRUE),
                (4, 8, '25000004P', 450.00, 400.00, 50.00, 'L', NULL, 'Confiscation', 'PCR-4', NULL, FALSE),
                (5, 9, '25000005L', 100.00, 50.00, 50.00, 'L', NULL, 'Fine', 'PCR-5', NULL, TRUE),
                (6, 9, '25000006H', 500.00, 500.00, 0.00, 'CS', '2025-07-02', 'Fixed Penalty', 'PCR-6', 'DW', FALSE),     --No alias
                (7, 10, '25000007D', 350.00, 150.00, 200.00, 'L', NULL, 'Confiscation', 'PCR-7', NULL, NULL),           --No alias
                (8, 10, '25000008W', 120.00, 60.00, 60.00, 'L', NULL, 'Fine', 'PCR-8', NULL, TRUE),
                (9, 11, '25000009S', 600.00, 300.00, 300.00, 'L', NULL, 'Conditional Caution', 'PCR-9', NULL, FALSE),    --No alias
                (10, 11, '25000010H', 250.00, 250.00, 0.00, 'CS', '2025-07-03', 'Fixed Penalty', 'PCR-10', NULL, NULL);  --No alias
    ...
    INSERT INTO creditor_transactions 
              (
                ...
                (2, 1001, '2025-07-04 11:00:00', 'admin02', 'Admin Two', 'BACS', 50.00, true, 'REF6002', 'C', '2025-07-04'),
                ...
                (5, 1002, '2025-07-05 13:20:00', 'admin03', 'Admin Three', 'BACS', 75.00, false, 'REF6005', 'C', '2025-07-05'),
                ...
                (8, 1003, '2025-07-06 10:35:00', 'admin02', 'Admin Two', 'BACS', 80.00, false, 'REF6008', 'C', '2025-07-06'),
                ...
                (11, 1004, '2025-07-07 14:45:00', 'admin03', 'Admin Three', 'BACS', 60.00, true, 'REF6011', 'C', '2025-07-07'),
                ...
                (14, 1005, '2025-07-05 16:30:00', 'admin01', 'Admin One', 'BACS', 80.00, true, 'REF6014', 'C', '2025-07-05'),
                ...
                (17, 1006, '2025-07-08 09:35:00', 'admin01', 'Admin One', 'BACS', 90.00, false, 'REF6017', 'C', '2025-07-08'),
                ...
                (20, 1007, '2025-07-05 15:50:00', 'admin03', 'Admin Three', 'BACS', 95.00, true, 'REF6020', 'C', '2025-07-05'),
                ...
                (23, 1008, '2025-07-08 14:40:00', 'admin02', 'Admin Two', 'BACS', 65.00, false, 'REF6023', 'C', '2025-07-08'),
                ...
                (26, 1009, '2025-07-07 08:55:00', 'admin01', 'Admin One', 'BACS', 85.00, true, 'REF6026', 'C', '2025-07-07'),
                ...
                (29, 1010, '2025-07-06 11:50:00', 'admin03', 'Admin Three', 'BACS', 70.00, true, 'REF6029', 'C', '2025-07-06'),
    ...
    FOR i IN 1..10 LOOP
        ...
        CASE i
            WHEN 1 THEN
                ...
                ASSERT v_collection_order IS TRUE, 'Collection order should be TRUE';
            ...
            WHEN 2 THEN
                ...
                ASSERT v_account_status = 'CS', 'Account status should match';
                ...
                ASSERT v_collection_order IS FALSE, 'Collection order should be FALSE';
            ...
            WHEN 7 THEN
                ...
                ASSERT v_completed_date::date IS NULL, 'Completed date should be NULL';
                ASSERT v_collection_order IS NULL, 'Collection order should be NULL';
