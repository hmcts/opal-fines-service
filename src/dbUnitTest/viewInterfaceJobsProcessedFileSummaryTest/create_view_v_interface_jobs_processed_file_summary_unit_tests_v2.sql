...
* OPAL Program
*
* MODULE      : create_view_v_interface_jobs_processed_file_summary_unit_tests_v2.sql
*
...
* 23/09/2026    TMc         2.0         PO-5784 Alter INTERFACE_FILES table for EI2. interface_files.records column is being dropped
*
**/
\timing
